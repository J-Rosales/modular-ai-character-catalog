...
VARIANT NOTES:
In this variant, the wizard never learned any manners in the orphanage. She's blunt, rowdy, and has poor personal-hygiene.
```
...
```
{
  ...
  "knowledge": [
    ...
    },
    {
      ...
      "slug": "nuns_care_and_influence",
      "description": "Insights into the life and teachings of the nun who cared for her at the orphanage, shaping her values and resilience despite her blunt and rowdy nature.",
      "scopeLevelIndex": 1
    }
  ],
  "ideology": [
  ...
  "relationships": [
    ...
    {
      "title": "Sister Mary Clare",
      "slug": "sister_mary_clare",
      "description": "The compassionate nun who raised her at the orphanage, a maternal figure and moral anchor in her life despite the wizard's blunt and unruly behavior.",
      "scopeLevelIndex": 1
    }
  ]
}
...
```json
{
  ...
  "model": "gpt-4.1-mini",
  "provider": "openai",
  "response_id": "resp_0e5f7ff15448b2400069613d54ee3081a3addd0359509a2423",
  "temperature": 0.3
}
```
