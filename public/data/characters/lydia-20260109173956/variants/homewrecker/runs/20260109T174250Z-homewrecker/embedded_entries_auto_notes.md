...
```
{
  ...
  "knowledge": [
    ...
    },
    {
      ...
      "description": "Information about the roles, personalities, and habits of the manor's staff members, including the Lord and Lady.",
      "scopeLevelIndex": 1
    }
  ],
  "ideology": [
  ...
  "relationships": [
    {
      ...
      "description": "The character's connection to the Lady, including service and occasional personal interactions, unaware of the secret affair.",
      "scopeLevelIndex": 1
    },
    {
      "title": "Lord of the Manor",
      "slug": "lord_of_the_manor",
      "description": "The character's formal relationship with the Lord, involving duties, respect, and a secret love affair.",
      "scopeLevelIndex": 1
    }
  ]
}
...
```json
{
  ...
  "model": "gpt-4.1-mini",
  "provider": "openai",
  "response_id": "resp_0225d17d9c77e8ed0069613e117cdc8192bacee2d9c611df7c",
  "temperature": 0.3
}
```
